...
\begin{definition}
  ...
  For a graph $\Gamma$, a \textit{framed graph} $\mathbf{\Gamma}$ is a 1-dimensional simplicial complex $\Gamma$ together with an embedding $\Gamma\hookrightarrow\Sigma$ of $\Gamma$ into a surface $\Sigma$ as a spine. In particular, when $\Gamma$ is a trivalent graph, $\mathbf{\Gamma}$ is called a \textit{framed trivalent graph}.
  \begin{figure}[H]
    \centering
