...
\begin{definition}
  ...
  Let $\Gamma$ be a trivalent graph, $\gamma\in \mathcal{K}(\Gamma)$ be a KTG, and $e$ be an edge of $\Gamma$. The \textit{switch the orientation} of $e$ is defined as reversing its orientation, and is denoted by $S_e(\gamma)$.
  \begin{figure}[htbp]
  \centering
...
\begin{figure}[H]
  ...
  \raisebox{-0.45\height}{\includegraphics[scale=0.6]{inkscape/ResF1.pdf}},\quad
