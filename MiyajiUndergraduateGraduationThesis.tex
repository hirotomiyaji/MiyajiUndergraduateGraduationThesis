...
\begin{proof}
  \begin{enumerate}
    \item $(\mathcal{I}^1(\Gamma)=\mathcal{F}_1(\Gamma))$\\
    $(\supset)$ 任意の$\mathcal{F}_1(\Gamma)$の元は少なくとも1つのdouble pointを持つような1-singular KTGの交点の正負の差を元に持つため，$\mathcal{F}_1(\Gamma)\subset \mathcal{I}(\Gamma)\subset\mathcal{I}^1(\Gamma)$. \\
